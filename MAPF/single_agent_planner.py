...
def build_constraint_table(constraints, agent):
    ...
    constraints_table = dict() # key: timestep, value: list of constraints for that timestep
    
    constraints_table['horizon'] = 0
        ...
        for constraint in constraint_table[next_time]:
            ...
            if len(constraint['loc']) == 1:
                ...
                if constraint['loc'][0] == curr_loc and constraint['loc'][1] == next_loc:
                    return True
                # elif constraint['loc'][0] == next_loc and constraint['loc'][1] == curr_loc:
                    # return True
...
def a_star(my_map, start_loc, goal_loc, h_values, agent, constraints, horizon = 20):
    ...
    earliest_goal_timestep = horizon
